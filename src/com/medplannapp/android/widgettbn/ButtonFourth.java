...
public class ButtonFourth extends TButton
{
	
	private final static String INTENT_ACTION = "com.medplannapp.android.widgettbn.ButtonFourth";
	...
	public int canHandleIntent(Context con)
	{
		...
		number = sp.getString("Fourth", "");
		if (!number.equalsIgnoreCase(""))
		{
			interval = sp.getInt("FourthTime", 1);
			callCount = sp.getInt("FourthCall", 1);
			mi = sp.getInt("FourthEmailTime", 1);
			mc = sp.getInt("FourthEmailCall",1);
			mail = sp.getString("FourthEmail", "");
			wt = sp.getString("FourthText", "");
