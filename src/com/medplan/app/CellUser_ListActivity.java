...
public class CellUser_ListActivity extends Activity implements
		OnClickListener {
	ListView l1;
	EditText etSearch;
	databasehelper db;
	...
	public void onCreate(Bundle icicle) {
		...
		btnHome.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(CellUser_ListActivity.this,
						MainActivity.class);
...
//														text.toUpperCase()))-1) == ' ')
						...
						if(tempUserList.size()==0){
							Toast.makeText(CellUser_ListActivity.this,R.string.no_record_found, Toast.LENGTH_SHORT).show();
						}
		...
		l1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(doWhat.equalsIgnoreCase("pick"))
				{
					...
					i.putExtra("contact", userList.get(arg2).mob);
					setResult(RESULT_OK, i);
					finish();
				}
				else if (doWhat.equalsIgnoreCase("list"))
				{
					Intent i = new Intent(CellUser_ListActivity.this,
...
//			holder.uImage.setImageBitmap(GlobalMethods.decodeSampledBitmapFromResource(temp.path, 80, 80));
