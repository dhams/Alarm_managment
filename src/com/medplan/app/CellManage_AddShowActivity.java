...
public class CellManage_AddShowActivity extends Activity implements
	...
	Spinner spMed, spBG, spSound, spBuzzRepeat, spAlarm, spWayToStop,
			...
			spDosageMgt, spHow_many, spWeek, spMonth;
	...
	boolean blAlert, blBlink, blMini, blVibrant, flgShowAlert = false,
			fromFillisTheForm = false  , isFromMediList;
...
//		spManyTime = (Spinner) findViewById(R.id.sptimeInterval);// delete this
		spIntervalDay = (Spinner) findViewById(R.id.sptimeInterval);
...
//			Log.d("Pending intent counter", "----- " + applicationClass.totalCounter);
			...
			int counter  = db.getLastNotificationId() ;
...
//				myIntent.setData(Uri.parse("custom://" + totalCounter));
//			    myIntent.setAction(String.valueOf(totalCounter));
